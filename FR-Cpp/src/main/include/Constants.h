...
namespace constant
{
    ...
    static constexpr int FRONT_LEFT_MOTOR   = 3;  // M3
    static constexpr int FRONT_RIGHT_MOTOR  = 2;  // M2
    static constexpr int BACK_LEFT_MOTOR    = 1;  // M1
    static constexpr int BACK_RIGHT_MOTOR   = 0;  // M0
